...
namespace lihua
{
    ...
    {
        EMlog(DEBUG, "===========add timer start.=============\n");
        if (!timer)
        {
            EMlog(WARN, "===========timer is nullptr.=============\n");
            return;
        }
        if (!head)
        {
    ...
    {
        EMlog(DEBUG, "===========adjust_timer start.=============\n");
        if (!timer)
        {
            EMlog(WARN, "===========timer is nullptr.=============\n");
            return;
        ...
        EMlog(DEBUG, "===========adjust_timer end.=============\n");
    }

    // 将目标定时器 timer 从链表中删除
    void Sort_timer_lst::del_timer(Util_timer *timer)
    {
        EMlog(DEBUG, "===========delete timer start.===========\n");
        if (!timer)
        {
            return;
        }
